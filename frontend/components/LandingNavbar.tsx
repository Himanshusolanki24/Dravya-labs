...
export default function LandingNavbar() {
    ...
    return (
        <nav className="fixed top-2 sm:top-4 left-1/2 -translate-x-1/2 z-50 bg-white/95 backdrop-blur-sm rounded-2xl md:rounded-none md:rounded-b-[20px] shadow-lg px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 flex items-center justify-between w-[95%] sm:w-[90%] max-w-4xl safe-area-top">
            {/* Left Navigation */}
